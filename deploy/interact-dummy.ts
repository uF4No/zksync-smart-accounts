 ...
 * smart contract account deployed manually.
 */
...
const ACCOUNT_ADDRESS = "0xd4567AA4Fd1B32A16c16CBFF9D9a69e51CF72293";
...
export default async function () {
  ...
  let aaTx = await contract.setGreeting.populateTransaction("Hello from AA!");
